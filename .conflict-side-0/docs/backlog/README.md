...
## 第三轮遗留清零（第四轮）— B14–B17（随各票登记）

| 编号 | 标题 | 优先级 |
|---|---|---|
| B16 | 测试宿主 dotnet run 兜底清零 | 中 |

> B16 由票15 随本提交登记；B14/B15/B17 由票13/14/16 窗口随各自提交登记。

## 第五轮 — B18–B22（随各票登记）

| 编号 | 标题 | 优先级 |
|---|---|---|
| B18 | 配置 round-trip 对称性止血（票17） | 高 |
| B19 | 规则存储完整往返（票18） | 高 |

> B18 由票17 随本提交登记（B18-config-roundtrip-stopbleed.md）；B19 由票18 随本提交登记（spec 拟票18=B18，因票17 先行占用 B18 顺延，B17 先例）；B20–B22 由票19/20/21 窗口随各自提交登记。
