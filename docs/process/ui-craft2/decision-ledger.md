...
- **状态**：**implemented（票面按实物 4 页收敛，票 04-07 全部完成并 ACCEPT，无幽灵工件）**（收口结算 2026-09-15）*
...
- **状态**：**implemented（票 03 职责边界声明+双落点实物：NavButton=结构/AppTheme=视觉）**（收口结算 2026-09-15）*
...
- **状态**：**implemented（票 08 从零新建：调研裁决自绘、规范 §6 升现役 v2.7、零新依赖、守卫 6 Fact）**（收口结算 2026-09-15）*
...
- **状态**：**implemented（票 03 撞红预演+三档处置留痕：改造2/保留2/新增1/杀0，新断言 R1 齐备）**（收口结算 2026-09-15）*
...
- **状态**：**implemented（票 01 首件 zml 词条入库，koy 悬空依赖随栈锚定消解；保险副本已入 docs）**（收口结算 2026-09-15）*
