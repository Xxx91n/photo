...
public sealed class LocalizationService : System.ComponentModel.INotifyPropertyChanged
{
    ...
    private static Dictionary<string, string> BuiltInZhCN() => new()
    {
        ...
        // 票 08（ui-craft2 / D-007）：toast 反馈链文案 —— 10 语言 JSON 同步（Locales/*.json toast 节点）。
        ["toast.config_saved"] = "已自动保存",
        ["toast.config_saved_worker_down"] = "已自动保存（Worker 未运行）",
        ["toast.config_save_failed"] = "保存失败",
        ["toast.rules_saved"] = "规则已保存",
        ["toast.rules_reset"] = "已恢复默认规则",
        ["toast.service_success"] = "服务操作成功",
        ["toast.service_failed"] = "服务操作失败",
        ["toast.service_cancelled"] = "操作已取消",
        ["toast.service_skipped"] = "操作已跳过",
        ["toast.dismiss"] = "关闭",
        ["msg.applied"] = "✓ 已应用",
    ...
    private static Dictionary<string, string> BuiltInEn() => new()
    {
        ...
        // ticket 08 (ui-craft2 / D-007): toast feedback chain strings — kept in sync with Locales/*.json.
        ["toast.config_saved"] = "Auto-saved",
        ["toast.config_saved_worker_down"] = "Auto-saved (Worker not running)",
        ["toast.config_save_failed"] = "Save failed",
        ["toast.rules_saved"] = "Rules saved",
        ["toast.rules_reset"] = "Rules reset to defaults",
        ["toast.service_success"] = "Service operation succeeded",
        ["toast.service_failed"] = "Service operation failed",
        ["toast.service_cancelled"] = "Operation cancelled",
        ["toast.service_skipped"] = "Operation skipped",
